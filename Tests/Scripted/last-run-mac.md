...
run, and a stamp that does not describe a real run is worse than no stamp at all.
    ...
    commit:   0f78510e80020f1a7abaf19592c35591400c539c
    tree:     clean
    database: rebuilt from the DDL
    started:  2026-09-07 08:57:34
    finished: 2026-09-07 09:14:43
    outcome:  failed
    scripts:  21 of 32 run, 0 with failures
...
| 11-google-reconnect | 17 | 17 | 0 | 0m 14s (0m 10s) |
...
| 56-manual-mode | 37 | 37 | 0 | 2m 38s (0m 25s) |
...
| 99-quit | 14 | 0 | 0 | - |
| **total** | **812** | **581** | **0** | **16m 23s (0m 45s)** |
