...
final class AppSettingsPane: NSView {
    ...
    var onChange: ((AppSettingsChange) -> Void)?
    ...
    func adopt(_ change: AppSettingsChange) {
        switch change {
    ...
    private func addRows() {
        ...
        dailyResetField = field(
            ...
            change: AppSettingsChange.dailyResetHour12
        )
        fetchIntervalField = field(
            ...
            change: AppSettingsChange.fetchIntervalMinutes
        )
        blipTimeField = field(
            ...
            change: AppSettingsChange.blipSeconds
        )
    ...
    private func field(
        ...
        suffix: String,
        change: @escaping (Int) -> AppSettingsChange
    ) -> SteppedNumberField {
